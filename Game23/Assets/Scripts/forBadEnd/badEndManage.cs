...
public class badEndManage : MonoBehaviour
{
    ...
    public float delayObject4 = 2f; // текст о работе
    ...
    void Start()
    {
        ...
        // Запускаем корутину, чтобы активировать object4 через указанное время
        StartCoroutine(ActivateObject4AfterDelay());
    }
    ...
    IEnumerator ActivateObject4AfterDelay()
    {
        yield return new WaitForSeconds(delayObject4);
